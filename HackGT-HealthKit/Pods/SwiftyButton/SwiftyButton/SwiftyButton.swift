...
open class SwiftyButton: UIButton {
    ...
    @IBInspectable open var buttonColor: UIColor = SwiftyButtonDefaults.buttonColor {
        didSet {
            updateBackgroundImages()
        }
    }
    
    @IBInspectable open var highlightedColor: UIColor? = SwiftyButtonDefaults.highlightedColor {
        didSet {
            updateBackgroundImages()
        }
    }
    
    @IBInspectable open var shadowColor: UIColor = SwiftyButtonDefaults.shadowColor {
        didSet {
            updateBackgroundImages()
        }
    }
    
    @IBInspectable open var shadowHeight: CGFloat = SwiftyButtonDefaults.shadowHeight {
        didSet {
            updateBackgroundImages()
            updateTitleInsets()
        }
    ...
    @IBInspectable open var cornerRadius: CGFloat = SwiftyButtonDefaults.cornerRadius {
        didSet {
            updateBackgroundImages()
        }
    }
    
    @IBInspectable open var disabledButtonColor: UIColor = SwiftyButtonDefaults.disabledButtonColor {
        didSet {
            updateBackgroundImages()
        }
    }
    
    @IBInspectable open var disabledShadowColor: UIColor = SwiftyButtonDefaults.disabledShadowColor {
        didSet {
            updateBackgroundImages()
        }
    }
    
    @IBInspectable open var buttonPressDepth: CGFloat = SwiftyButtonDefaults.buttonPressDepth {
        didSet {
            updateBackgroundImages()
            updateTitleInsets()
        }
